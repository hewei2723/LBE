...
public class sqlite extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "mcfood.db";
    ...
    public void insertDefaultUser(SQLiteDatabase db) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_USERNAME, "何炜");
        values.put(COLUMN_PASSWORD, "2022010611");
